...
function ReconfigGear(X2ItemTemplate Template, int Difficulty)
{
	...
	if (WeaponTemplate != none)
	{
		...
		if (WeaponTemplate.DataName == 'Sword_BM' || WeaponTemplate.DataName == 'WristBlade_BM' || WeaponTemplate.DataName =='WristBladeLeft_BM' || WeaponTemplate.DataName == 'Sword_BM' || WeaponTemplate.DataName == 'AlienHunterAxe_Beam' || WeaponTemplate.DataName == 'AlienHunterAxeThrown_Beam')
		{
